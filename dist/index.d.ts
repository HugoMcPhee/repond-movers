...
export declare function addMoverEffects<T_ItemType extends ItemType, T_Name extends StateNameProperty<T_ItemType>>(store: T_ItemType, moverName: T_Name, moverType?: MoverType): Record<`${T_Name}GoalChanged`, any> & Record<`${T_Name}StartedMoving`, any>;
